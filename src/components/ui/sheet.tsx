...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/40 backdrop-blur-sm opacity-0 data-[state=open]:opacity-100 transition-opacity duration-300 ease-[var(--ease-out-strong)]",
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition-transform duration-300 ease-[var(--ease-out-strong)]",
  {
    variants: {
      side: {
